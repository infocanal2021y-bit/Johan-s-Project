...
# Get token first
login_response = requests.post('https://compliance-dash-32.preview.emergentagent.com/api/auth/login', json={
...
# Get accounts
accounts_response = requests.get('https://compliance-dash-32.preview.emergentagent.com/api/accounts', headers=headers)
...
transfer_response = requests.post('https://compliance-dash-32.preview.emergentagent.com/api/transactions', 
    headers=headers,
    json={
