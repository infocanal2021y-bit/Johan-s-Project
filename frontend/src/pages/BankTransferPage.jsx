            ...
            <div className="max-w-3xl mx-auto" data-testid="bank-transfer-page">
                ...
                <div className="mb-6">
                    ...
                    <a
                        ...
                        className="mt-4 flex items-center gap-3 p-3.5 rounded-xl bg-[#25D366]/10 border border-[#25D366]/30 hover:bg-[#25D366]/15 transition-colors"
                    >
                        <svg viewBox="0 0 32 32" width="22" height="22" fill="#25D366" className="flex-shrink-0">
                        ...
                        <div className="min-w-0">
                            <p className="text-[#25D366] font-semibold text-sm">¿Dudas con la transferencia? WhatsApp</p>
                            <p className="text-slate-400 text-xs font-mono mt-0.5">+44 7400 757168 · atención directa</p>
                        </div>
                    </a>
                </div>
